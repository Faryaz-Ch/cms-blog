...
<?php require_once('inc/header.php');
      ...
      if(isset($_POST['search'])){
          ...
          $all_posts_run = mysqli_query($con, $all_posts_query);//This function will fetch all those rows whose Posts status is published.
          $all_posts = mysqli_num_rows($all_posts_run);//this function will count the rows.
          $total_pages = ceil($all_posts / $number_of_posts);//Count total pages. The ceil() function rounds a number UP to the nearest integer.
          ...
          $total_pages = ceil($all_posts / $number_of_posts);//The ceil() function rounds a number UP to the nearest integer.
          $posts_start_from = ($page_id - 1) * $number_of_posts;
      }
...
?>
    ...
    <div class="jumbotron">
        <div class="container">
            <div id="details" class="animated fadeInLeft">
                ...
                <p>This is an online News Portal</p>
            </div>
        </div>
  ...
  <!-- Indicators -->
                      ...
                      <div class="carousel-inner" role="listbox">
                       <?php 
                        $check = 0;
                          ...
                          ?>
                          <a href="post.php?post_id=<?php echo $slider_id;?>"><img src="images/<?php echo $slider_image;?>"></a>
                    ...
                    if(isset($_POST['search'])){
                        ...
                        $query .= " and tags LIKE '%$search%'";//.= is Concatenation assignment
                    ...
                    <nav id="pagination">
                      <ul class="pagination">
                        <?php
						  //concatenation operator (.) is used below. which is used to combine two sting values to create one string & Application of active class.
