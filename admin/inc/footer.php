 <footer class="text-center"> Copyright &copy; by <a href="#">Express Pakistan</a> <?php echo date('Y');?> </footer>
</div>
		...
		<script src="js/code.js"></script><!--jQuery file for Select & de-select-->
		<script>
tinymce.init({
