...
//username (Role validation) here
$session_username = $_SESSION['username'];

//Comment delete. SELECT and DELETE statement has been used here
if(isset($_GET['del'])){ 
    $del_id = $_GET['del'];
...
//Comment approve. SELECT and UPDATE statement has been used here
...
//Comment unapprove. SELECT and UPDATE statement has been used here
...
//Bulk options. DELETE and UPDATE statement has been used here.
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <?php
                        ...
                        echo "<center><h2>No Comments Availabe</h2></center>";
                    }
                    ?>
                    </form>
                </div>
