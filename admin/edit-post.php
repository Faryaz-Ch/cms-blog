...
if(isset($_GET['edit'])){
    ...
    if($session_role == 'admin'){
        $get_query = "SELECT * FROM posts WHERE id = $edit_id";//Admin can edit all posts
        $get_run = mysqli_query($con, $get_query);
    }
    else if($session_role == 'author'){
        $get_query = "SELECT * FROM posts WHERE id = $edit_id and author = '$session_role'";//Author will be able to edit his/her post not others.
        $get_run = mysqli_query($con, $get_query);
    }
    //Get post data
